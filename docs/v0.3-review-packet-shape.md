...
Packet sections are conditional. Keep each section short; mark optional or not-applicable sections as `N/A` with a reason instead of filling them mechanically.
